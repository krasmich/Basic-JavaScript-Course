...
function showCategory(category) {
    let objProducts = products[category];
    let DivProducts = '';
    objProducts.forEach(product => DivProducts += getProductMarkup(product));
    productsDiv.insertAdjacentHTML('afterbegin', DivProducts);
}
