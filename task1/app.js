...
function handleClick(clickedButtonEvent) {
    ...
    let ButtonContent = card.button.innerText;
...
function showMoreText(card) {
    ...
    let content = 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus, quaerat ex aspernatur saepe consectetur fugiat iste doloremque, ut dolore reprehenderit officiis assumenda sint ad est? Dolor, provident? Corporis, a eveniet.';
    // 6.2 внутри .product есть .productName, после него вставляем div.desc и текстом из переменной из п. 6.1
    card.productName.insertAdjacentHTML('afterend', `<div class="desc">${content}</div>`);
